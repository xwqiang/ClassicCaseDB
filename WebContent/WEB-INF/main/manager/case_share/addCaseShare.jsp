...
<link type="text/css" rel="stylesheet" href="js/validateEngine/validationEngine.jquery.css" />
...
<div id="main" class="clearfix">
	...
	<div id="frame" class="frame" style="overflow:hidden;"><div>
	    ...
	    <form name="formID" id="formID" action="insertCaseShare.do" method="post">
		    <div class="case_m_item">
		    	<div class="case_left">案例标题:</div>
		    	<div class="case_cont"><input type="text" name="title" id="title" class="validate[required]"/></div>
		    </div>
		    <div class="case_m_item">
		    ...
		    <div class="case_m_item">
	           ...
	           <div class="case_cont">
	        	<select name="server_id" id="server_id" class="validate[required]">
		    ...
		    <div class="case_m_item">
		        ...
		        <div class="case_cont"><input type="text" name="service_code" id="service_code" class="validate[required,number]"/></div>
		    </div>
		    ...
		    <div class="case_m_item">
		      ...
		      <div class="case_m_item">
		        ...
		        <div class="case_cont">
		        	<textarea name="summa" id="summa" cols="90" rows="5" class="validate[required]"></textarea>
		        </div>
		      </div>
		      ...
		      <div class="case_m_item">
		        ...
		        <div class="case_cont">
			        <textarea name="analysize" id="analysize" cols="90" rows="5" class="validate[required]"></textarea>
		        </div>
		      </div>
		      ...
		      <div class="case_m_item">
		        ...
		        <div class="case_cont">
		        	<textarea name="deal_result" id="deal_result" cols="90" rows="5" class="validate[required]"></textarea>	
		       	</div>
		      </div>
		      ...
		      <div class="case_m_item">
		        ...
		        <div class="case_cont">
					<textarea name="conclusion" id="conclusion" cols="90" rows="5" class="validate[required]"></textarea>	
				</div>
		      </div>
		    ...
		    <div class="case_m_item">
		        ...
		        <div class="case_cont">
					<textarea name="comment" id="comment" cols="90" rows="3"></textarea>	
				</div>
			</div>
			...
			<div class="case_m_item">
		    	<div class="case_btn">
			    	...
			    	<input type="submit" class="iptBtn" value="提交"/>			    	
		    	</div>
	    	</div>
		</form>
	    </div>
